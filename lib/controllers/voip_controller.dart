...
import 'package:flutter_callkit_incoming/entities/entities.dart' as evt;
...
class VoipController {
  ...
  endCall(Call call) {
    ...
    FlutterCallkitIncoming.endCall(call.uuid);
  }
  ...
  listenerSetup() {
    ...
    //       FlutterCallkitIncoming.endCall(params["id"]);
    ...
    FlutterCallkitIncoming.onEvent.listen((event) {
      switch (event!.event) {
        case evt.Event.ACTION_CALL_INCOMING:
          getIt<SocketManager>().connect();
          break;
        case evt.Event.ACTION_CALL_START:
          log("starting the call");
          break;
        case evt.Event.ACTION_CALL_ACCEPT:
          CallData callData = CallData.fromJson(event.body);
          ...
          agoraCallController.acceptCall(call: call);
          break;
        case evt.Event.ACTION_CALL_DECLINE:
          // TODO: declined an incoming call
          break;
        case evt.Event.ACTION_CALL_ENDED:
          Call call = Call(
              uuid: event.body['id'],
              channelName: '',
              isOutGoing: false,
          ...
          agoraCallController.endCall(call);
          break;
        case evt.Event.ACTION_CALL_TIMEOUT:
          // TODO: missed an incoming call
          break;
        case evt.Event.ACTION_CALL_CALLBACK:
          // TODO: only Android - click action `Call back` from missed call notification
          break;
        case evt.Event.ACTION_CALL_TOGGLE_HOLD:
          // TODO: only iOS
          break;
        case evt.Event.ACTION_CALL_TOGGLE_MUTE:
          // TODO: only iOS
          break;
        case evt.Event.ACTION_CALL_TOGGLE_DMTF:
          // TODO: only iOS
          break;
        case evt.Event.ACTION_CALL_TOGGLE_GROUP:
          // TODO: only iOS
          break;
        case evt.Event.ACTION_CALL_TOGGLE_AUDIO_SESSION:
          // TODO: only iOS
          break;
        case evt.Event.ACTION_DID_UPDATE_DEVICE_PUSH_TOKEN_VOIP:
          // TODO: only iOS
          break;
      }
    });
